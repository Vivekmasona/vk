...
ytproDownDiv.style.maxHeight="40%";
ytproDownDiv.style.overflow="scroll";
ytproDownDiv.style.background="rgba(44, 203, 183, 1)";
...
ytproDownDiv.innerHTML="<style>#downytprodiv a{text-decoration:none;color:white;} #downytprodiv li{list-style:none;color:#0dd;padding:10px;background:#fff;border:1px solid silver;margin:5px;text-align:lft;}</style>";
ytproDownDiv.innerHTML+="<span style='position:absolute;top:15px;left:15px;color:#04C5B9;font-size:30px;' onclick='"+"this.parentElement.parentElement.style.display="+'"'+"none"+'"'+";'>&#x2715;</span>Visite ❤️PAHILAGANA❤️For More Downloads <ul id='listurl'>";
...
ytproAudElem.innerHTML='<i class="fa fa-music" style="font-size:24px;color:red"></i><br>Music '
...
ytproAudDivElem.style.background="#04C5B9";
...
ytproAudX.style.background="rgba(0,0,0,.7)";
...
ytproAudDivElem.innerHTML+="<style>audio::-webkit-media-controls-panel{background:#04C5B9;}</style>";
